...
function ale_enqueue_styles() {
    ...
    wp_register_style( 'color1', THEME_URL . '/css/preview/color1.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_register_style( 'color2', THEME_URL . '/css/preview/color2.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_register_style( 'color3', THEME_URL . '/css/preview/color3.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_register_style( 'color4', THEME_URL . '/css/preview/color4.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_register_style( 'color5', THEME_URL . '/css/preview/color5.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_register_style( 'color6', THEME_URL . '/css/preview/color6.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_register_style( 'color7', THEME_URL . '/css/preview/color7.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_register_style( 'color8', THEME_URL . '/css/preview/color8.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_register_style( 'color9', THEME_URL . '/css/preview/color9.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_register_style( 'color10', THEME_URL . '/css/preview/color10.css', array(), ALETHEME_THEME_VERSION, 'all');
    ...
    if(ale_get_option('site_color')){
        if(!isset($_COOKIE["nuntacolor"])) {
            wp_enqueue_style(ale_get_option('site_color'));
        } else {
            wp_enqueue_style($_COOKIE["nuntacolor"]);
        }
    } else {
        wp_enqueue_style('color1');
    }
...
function ale_enqueue_scripts() {
    ...
    wp_register_script( 'jquery.eislideshow', THEME_URL . '/js/libs/jquery.eislideshow.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'jquery.easing.1.3', THEME_URL . '/js/libs/jquery.easing.1.3.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'jquery.countdown.min', THEME_URL . '/js/libs/jquery.countdown.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );

    if(is_post_type_archive('gallery') or is_tax('gallery-category') or is_page_template('template-gallery.php') or is_page_template('template-home-four.php') or is_page_template('template-home-five.php')) {
...
function aletheme_comment($comment, $args, $depth) {
	...
	<li <?php comment_class(); ?> data-comment-id="<?php echo $comment->comment_ID?>">
		<div id="comment-<?php comment_ID(); ?>">
			<header class="comment-author vcard cf mainfont">
